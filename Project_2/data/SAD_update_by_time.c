...
int main ()
{
    ...
    int test_case= 0;
    //preprocessor part - initialize temp.jpg
    ...
    while(test_case <= 62){
        ...
        char save_path[50];
        sprintf(save_path, "%s%d%s", "./SAD_result/tracking/With_comparison/output", test_case, ".jpg");
        ...
        pixel tmp_1= matching_SAD(image_tmp, image_sub, width_main, height_main, channel_tmp, width_sub, height_sub, channel_sub);
        ...
        if(tmp1.val > tmp2.val && tmp_2.val >= 1376181){
            pixel result= tmp_1;
